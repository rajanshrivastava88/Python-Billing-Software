...
class Bill_App:
    def __init__(self,root):
       ...
       #======== Customer Detail Frame ===========>>>>
        ...
        bill_btn=Button(F1,text="Search",command=self.find_bill,width=10,bd=7,font="arial 12 bold").grid(row=0,column=6,padx=1,pady=1)


        #====== Cosmetics Frame =======>>>>

        F2=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cosmetics",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F2.place(x=5,y=160,width=320,height=370)
        ...
        Hair_gel_txt=Entry(F2,width=10,textvariable=self.Hair_gell,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=4,column=1,padx=10,pady=10)
        ...
        F3=LabelFrame(self.root,bd=10,relief=GROOVE,text="Grocery Products",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F3.place(x=330,y=160,width=320,height=370)
        ...
        g2_lbl=Label(F3,text="Mustard Oil",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        g2_txt=Entry(F3,width=10,textvariable=self.mustard_oil,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=1,column=1,padx=10,pady=10)
        ...
        g6_lbl=Label(F3,text="Salt",font=("times new roman",16,"bold"),bg=bg_color,fg="lightgreen").grid(row=5,column=0,padx=10,pady=10,sticky="w")
        g6_txt=Entry(F3,width=10,textvariable=self.salt,font=("times new roman",16,"bold"),bd=5,relief=SUNKEN).grid(row=5,column=1,padx=10,pady=10)

        #<<<<<<<<=========== Cold Drink Frame  ===========>>>>>>>>

        F4=LabelFrame(self.root,bd=10,relief=GROOVE,text="Cold Drink Products",font=("times new roman",15,"bold"),fg="gold",bg=bg_color)
        F4.place(x=655,y=160,width=320,height=370)
        ...
        F5.place(x=982,y=160,width=288,height=370)
        ...
        F6.place(x=0,y=533,relwidth=1,height=135)
        ...
        btn_F.place(x=750,width=510,height=105)

        total_btn=Button(btn_F,command=self.total,text="Total",bg="cadetblue",fg="white",bd=5,pady=15,width=11,font="arial 11 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn=Button(btn_F,text="Generate Bill",command=self.bill_area,bg="cadetblue",fg="white",bd=5,pady=15,width=11,font="arial 11 bold").grid(row=0,column=1,padx=5,pady=5)
        Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="cadetblue",fg="white",bd=5,pady=15,width=11,font="arial 11 bold").grid(row=0,column=2,padx=5,pady=5)
        Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="cadetblue",fg="white",bd=5,pady=15,width=11,font="arial 11 bold").grid(row=0,column=3,padx=5,pady=5)
    ...
    def total(self):
        ...
        self.c_d_m_p=self.maza.get()*80
        self.c_d_c_p=self.cock.get()*70
        self.c_d_f_p=self.frooti.get()*75
        self.c_d_t_p=self.thumbsup.get()*60
        self.c_d_l_p=self.limca.get()*50
        self.c_d_s_p=self.sprite.get()*75
        self.total_cold_drinks_price=float(self.c_d_m_p+
                                           self.c_d_c_p+
                                           self.c_d_f_p+
                                           self.c_d_t_p+
                                           self.c_d_l_p+
    ...
    def bill_area(self):
        ...
        if self.mustard_oil.get()!=0:
            self.txtarea.insert(END,f"\nMustard Oil\t\t{self.mustard_oil.get()}\t{self.g_m_p}")
        if self.daal.get()!=0:
        ...
        #===== Cold Drinks =======>>>>>
        if self.maza.get()!=0:
            self.txtarea.insert(END,f"\nMaza\t\t{self.maza.get()}\t{self.c_d_m_p}")
    
        if self.cock.get()!=0:
            self.txtarea.insert(END,f"\nCock\t\t{self.cock.get()}\t{self.c_d_c_p}")
        if self.frooti.get()!=0:
            self.txtarea.insert(END,f"\nFrooti\t\t{self.frooti.get()}\t{self.c_d_f_p}")
            
        if self.thumbsup.get()!=0:
            self.txtarea.insert(END,f"\nThumbs up\t\t{self.thumbsup.get()}\t{self.c_d_t_p}")
        if self.limca.get()!=0:
